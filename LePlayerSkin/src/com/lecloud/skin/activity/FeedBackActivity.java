...
public class FeedBackActivity extends Activity implements IFeedBackListener {
    ...
    private void initReportView() {
        ...
        feedBtnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LeLogSubmit.submitLog(phone, feedContent, onLogSubmitResultListener);
    ...
    private OnLogSubmitResultListener onLogSubmitResultListener = new OnLogSubmitResultListener() {
        @Override
    ...
    protected void onDestroy() {
        super.onDestroy();
        onLogSubmitResultListener = null;
    }
