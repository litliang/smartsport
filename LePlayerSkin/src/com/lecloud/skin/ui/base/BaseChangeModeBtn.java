...
public abstract class BaseChangeModeBtn extends BaseBtn {
    ...
    //陀螺仪
    public static final int CONTROLL_MODE_MOVE = BasePanoSurfaceView.CONTROLL_MODE_MOTION;
    //手势＋陀螺仪
    public static final int CONTROLL_MODE_MOTION_WITH_TOUCH = BasePanoSurfaceView.CONTROLL_MODE_MOTION_WITH_TOUCH;
            ...
            public void onClick(View v) {
                if (checkSensor()) {
                    if (controllMode == CONTROLL_MODE_TOUCH) {
                        controllMode = CONTROLL_MODE_MOTION_WITH_TOUCH;
                    } else {
