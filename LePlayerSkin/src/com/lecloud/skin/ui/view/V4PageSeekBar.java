...
public class V4PageSeekBar extends View {
    ...
    private int measureHeight(int heightMeasureSpec) {
        ...
        int height = Math.max(
                Math.max(leftIndicatorHeight /* left indicator portraitHeight */,
                        rightIndicatorHeight /* right indicator portraitHeight */),
        ...
        // Add bottom text portraitHeight
