...
public interface ILetvUICon {
    ...
    void addWaterMark(CoverConfig coverConfig);

    void showLoadingAnimation();

    void showLoadingPic(CoverConfig coverConfig);
    ...
    //用户设置 是否开启陀螺仪模式
    void isOpenGyroMode(boolean gyroMode);

    void changeScreenLandscape(View view);
}
