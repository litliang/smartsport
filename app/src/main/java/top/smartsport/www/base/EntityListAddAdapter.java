 ...
 */
public abstract class EntityListAddAdapter<T, VH extends ViewHolder> implements ListAdapter {
    ...
    public EntityListAddAdapter(Context context) {
        this(context, null);
    }

    public EntityListAddAdapter(Context context, List<T> list) {
        if (list == null) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        VH mViewHolder = null;
        if (convertView == null) {
            convertView = inflater.inflate(getAdapterRes(position), parent, false);
    ...
    protected abstract int getAdapterRes(int position);
