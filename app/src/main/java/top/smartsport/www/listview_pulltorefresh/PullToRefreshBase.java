package top.smartsport.www.listview_pulltorefresh;
 ...
 * 这个实现了下拉刷新和上拉加载更多的功能
 */
@SuppressLint("NewApi") public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    /**
     * 定义了下拉刷新和上拉加载更多的接口。
     */
