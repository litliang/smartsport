 ...
 * 青训--在线案例
 */
@ContentView(R.layout.fragment_sczxja)
public class SCZXJAV4Fragment extends BaseV4Fragment {
    ...
    public static SCZXJAV4Fragment newInstance() {
        SCZXJAV4Fragment fragment = new SCZXJAV4Fragment();
