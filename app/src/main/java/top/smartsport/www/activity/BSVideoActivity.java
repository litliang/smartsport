...
public class BSVideoActivity extends BaseActivity {
...
//        videoView.setDataSource(getIntent().getStringExtra("fileurl").toString());
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (ScreenUtils.getOrientation(BSVideoActivity.this) == Configuration.ORIENTATION_LANDSCAPE) {
