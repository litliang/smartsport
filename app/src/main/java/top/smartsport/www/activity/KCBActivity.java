...
public class KCBActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        callHttp(MapBuilder.build().add("match_id", "1").add("action", "getSchedule").get(), new QXFunCallback() {
            ...
            public void onCallback(NetEntity result, List<Object> object) {
                ...
                Map<View, Object> views = new TreeMap<View, Object>();
                for (int i = 0; i < count; i++) {
                    views.put(new ViewInflater(KCBActivity.this).inflate(R.layout.fragment_bssc,null),((Map)list.get(i)).get("list"));
                ...
                qxzxAdapter = new ViewPagerAdapter(views);
    ...
    private class ViewPagerAdapter extends PagerAdapter {
        ...
        public Map<View, Object> viewMaps;
        List<View> views;

        public ViewPagerAdapter(Map<View, Object> viewMpas) {
            this.views = new ArrayList<View>(viewMaps.keySet());
        }
        ...
        public Object instantiateItem(ViewGroup view, int position) {
            ...
            MapConf.with(view.getContext()).pair("home_name->home_name").pair("home_score->home_score").pair("home_logo->home_logo").pair("away_name->away_name").pair("away_score->away_score").pair("away_logo->away_logo").pair("start_time->start_time").source(((Map)viewMaps.get(views.get(position))).get("list"), views.get(position).findViewById(R.id.lv)).source(R.layout.scb_item).match();
